...
<!-- Faculty Assignment Reminder Page -->
...
<html>
    <head>
        ...
        <title>BMCC Resolve | Faculty | Assignment Reminder</title>
    </head>
    ...
    <body>
        ...
        <h3 style="text-align: center;">Under Construction (Faculty's Assignment Reminder Page)</h3>
    </body>
</html>